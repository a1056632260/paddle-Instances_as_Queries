...
class ArgsParser(ArgumentParser):
    def __init__(self):
        ...
        #self.add_argument("-c", "--config", help="configuration file to use",default='../configs/cascade_rcnn/cascade_mask_rcnn_r50_fpn_1x_coco.yml')
        self.add_argument("-c", "--config", help="configuration file to use",default='C:/Users/saxsax/Desktop/PaddleDetection-release-2.4/configs/query_inst/queryinst_r50_fpn_1x_coco.yml')
